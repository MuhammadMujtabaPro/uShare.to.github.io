            ...
            <tr valign="top">
                ...
                <td>
                    <input type="text" name="adfoin_livestorm_api_token"
                           ...
                           class="regular-text"/>
                    <p class="description" id="code-description"><?php _e( 'Please go to Account Settings > App marketplace > Public API > Generate a Token', 'advanced-form-integration' ); ?></a></p>
                </td>
            </tr>
        </table>
        <?php submit_button(); ?>
