...
function adfoin_capsulecrm_send_data( $record, $posted_data ) {
    ...
    if( $task == "add_party" ) {
        ...
        if( isset( $org_data['name'] ) && $org_data['name'] ) {
            ...
            if( isset( $org_body['party'] ) && isset( $org_body['party']['id'] ) ) {
        ...
        if( isset( $person_data['firstName'] ) && $person_data['firstName'] ) {
            ...
            if( isset( $person_body['party'] ) && isset( $person_body['party']['id'] ) ) {
        ...
        if( isset( $opportunity_data['name'] ) && $opportunity_data['name'] ) {
            ...
            if( isset( $opportunity_body['opportunity'] ) && isset( $opportunity_body['opportunity']['id'] ) ) {
        ...
        if( isset( $case_data['name'] ) && $case_data['name'] ) {
            ...
            if( isset( $case_body['kase'] ) && isset( $case_body['kase']['id'] ) ) {
        ...
        if( isset( $task_data['description'] ) && $task_data['description'] ) {
            ...
            if( isset( $task_body['kase'] ) && isset( $task_body['kase']['id'] ) ) {
