...
function adfoin_onehash_settings_view( $current_tab ) {
    ...
    <form name="onehash_save_form" action="<?php echo  esc_url( admin_url( 'admin-post.php' ) ) ;?>" method="post" class="container">
        ...
        <tr valign="top">
            ...
            <td>
                <input type="text" name="adfoin_onehash_company" value="<?php echo  $company; ?>" placeholder="<?php _e( 'Enter company subdomain', 'advanced-form-integration' ); ?>" class="regular-text"/>
            </td>
        </tr>
        <tr valign="top">
            <th scope="row"> <?php _e( 'API Key', 'advanced-form-integration' ); ?></th>
            <td>
                <input type="text" name="adfoin_onehash_api_key" value="<?php echo  $api_key ;?>" placeholder="<?php _e( 'Enter API Key', 'advanced-form-integration' ); ?>" class="regular-text"/>
                <p>
        ...
        <tr valign="top">
            ...
            <td>
                <input type="text" name="adfoin_onehash_api_secret" value="<?php echo  $api_secret ;?>" placeholder="<?php _e( 'Enter API Secret', 'advanced-form-integration' ); ?>" class="regular-text"/>
            </td>
        </tr>
    </table>
    <?php submit_button(); ?>
