...
function adfoin_customerio_settings_view( $current_tab ) {
    ...
    <form name="customerio_save_form" action="<?php echo  esc_url( admin_url( 'admin-post.php' ) ) ;?>" method="post" class="container">
        ...
        <tr valign="top">
            ...
            <td>
                <input type="text" name="adfoin_customerio_site_id" value="<?php echo  $site_id ;?>" placeholder="<?php _e( 'Enter Site ID', 'advanced-form-integration' ); ?>" class="regular-text"/>
                <p>
        ...
        <tr valign="top">
            ...
            <td>
                <input type="text" name="adfoin_customerio_api_key" value="<?php echo  $api_key ;?>" placeholder="<?php _e( 'Enter API Key', 'advanced-form-integration' ); ?>" class="regular-text"/>
                <p>
                    Go to Settings > Account Settings > API Credentials
                </p>
            </td>
