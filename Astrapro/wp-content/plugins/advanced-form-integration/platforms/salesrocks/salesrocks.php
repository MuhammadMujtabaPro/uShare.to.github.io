            ...
            <tr valign="top">
                ...
                <td>
                    <input type="text" name="adfoin_salesrocks_username"
                           value="<?php echo $username; ?>" placeholder="<?php _e( 'Enter Username', 'advanced-form-integration' ); ?>"
                           class="regular-text"/>
                </td>
            </tr>
            ...
            <tr valign="top">
                ...
                <td>
                    <input type="password" name="adfoin_salesrocks_password"
                           value="<?php echo $password; ?>" placeholder="<?php _e( 'Enter Password', 'advanced-form-integration' ); ?>"
                           class="regular-text"/>
                </td>
            </tr>
        </table>
